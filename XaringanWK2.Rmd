...
---
# Introduction
Synthetic-aperture radar is a type of active remote sensing method.In addition,SAR systems produce high resolution imagery by utilising the long-range propagation properties of radar signals and the sophisticated information processing power of contemporary digital electronics.

The image below is the Teide volcano which acquired by SAR.

```{r  echo=FALSE, out.width='35%', fig.align='center'}
knitr::include_graphics('TEIDE.jpg')
```
---
# Principles of SAR
A synthetic-aperture radar is an imaging radar mounted on a mobile platform.  The system electronics sequentially transmits electromagnetic waves, gathers echoes, digitises the data, and stores it for later processing.   Transmission and reception map to distinct small positions because they happen at different times.   The virtual aperture created by the well-organized combination of the received signals is substantially longer than the actual antenna width.   Its origins give rise to the term "synthetic aperture," which confers on it the capability of imaging radar. 
---

---
# The application of Radar remote sensing
In Genral, Radar remote sensing can be used for digital elevation mapping, soil mapping, vegetation cover mapping, archaeological applications, and other purposes due to its all-weather imaging capability and particular range of EMR spectrum.  This type of technology is being used by several satellite-based sensors to generate remote sensing data based on radar.
