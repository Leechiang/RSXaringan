...
The PALSAR-2 aboard ALOS-2 is an L-band Synthetic Aperture Radar(SAR) sensor, a microwave sensor that emits L-band radio waves and receives their reflection from the ground to acquire information. 
...
The first SAR instrument was launched into orbit more than 40 years ago, with all-weather, all-time capabilities, SAR was still viewed as a backup option to visual and other sensors.   Modern SAR sensors have several modes and special capabilities.  But there are still a lot of obstacles to overcome (Arsenios Tsokas et al., 2022):
...
---
# Reflection: How to reach the best performance of SAR
